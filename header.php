        ...
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <a href="https://flowbite.com" class="flex items-center">
                <?php 
                    ...
                    if(has_custom_logo( )) :
                ?>
                    <img src="<?= esc_url( $logo[0] ) ?>" class="mr-3 h-6 sm:h-9" alt="Flowbite Logo" />
                <?php endif; ?>
                <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white"><?= get_bloginfo('name') ?></span>
            </a>
